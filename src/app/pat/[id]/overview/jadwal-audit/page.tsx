...
export default function TimAudit() {
  const rows = [
    {
      name: "Audit RAO Palembang",
      type: "Informal",
      maker: "Bambang Sutyo",
      createdAt: "2023-07-12 10:42 AM",
      managerOfAudit: "30 Days",
      headOfAudit: "Regular",
      member: "N/A",
    },
    {
      name: "Audit KC Sumedang",
      type: "Formal",
      maker: "Ilham Arifin",
      createdAt: "2023-10-18 03:21 PM",
      managerOfAudit: "15 Days",
      headOfAudit: "Special",
      member: "N/A",
    },
    {
      name: "Audit KC Bandung",
      type: "Formal",
      maker: "Mela Purnomo",
      createdAt: "2023-11-29 08:15 AM",
      managerOfAudit: "20 Days",
      headOfAudit: "Regular",
      member: "N/A",
    },
  ];
        ...
        <header className="sticky top-0 z-30 flex h-14 items-center gap-4 border-b bg-background px-4 sm:static sm:h-auto sm:border-0 sm:bg-transparent sm:px-6">
          <Breadcrumb className="hidden md:flex">
            <BreadcrumbList>
              ...
              <BreadcrumbSeparator />
              <BreadcrumbItem>
                <BreadcrumbPage>Jadwal Audit</BreadcrumbPage>
              </BreadcrumbItem>
            </BreadcrumbList>
          </Breadcrumb>
        </header>
            ...
            <TabsContent value="all">
              <Card x-chunk="dashboard-06-chunk-0">
                <CardHeader>
                  ...
                  <CardDescription>Pengelolaan Jadwal Audit.</CardDescription>
                </CardHeader>
                <CardContent>
                  <Table>
                    <TableHeader>
