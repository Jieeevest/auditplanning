  ...
  const rows = [
    {
      ...
      headOfAudit: "Samantha",
      member: "Ferdi Puska",
    },
    {
      name: "Addendum ke 2",
      type: "Individual",
      maker: "Alvin Haryanto",
      createdAt: "2023-10-18 03:21 PM",
      managerOfAudit: "Rohendi Aritua",
      headOfAudit: "Dean Sutanto",
      member: "Adrian Paul",
    },
  ];
        ...
        <header className="sticky top-0 z-30 flex h-14 items-center gap-4 border-b bg-background px-4 sm:static sm:h-auto sm:border-0 sm:bg-transparent sm:px-6">
          <Breadcrumb className="hidden md:flex">
            <BreadcrumbList>
              ...
              <BreadcrumbSeparator />
              <BreadcrumbItem>
                <BreadcrumbPage>Jadwal Lain</BreadcrumbPage>
              </BreadcrumbItem>
            </BreadcrumbList>
          </Breadcrumb>
        </header>
          ...
          <Tabs defaultValue="all">
            ...
            <TabsContent value="all">
              <Card x-chunk="dashboard-06-chunk-0">
                <CardHeader>
                  <CardTitle>Jadwal Lainnya</CardTitle>
                  <CardDescription>Pengelolaan Jadwal Lainnya.</CardDescription>
                </CardHeader>
                <CardContent>
                  <Table>
                    <TableHeader>
